...
Hinsichtlich der verwendeten Begriffe, wie z. B. „Verarbeitung", „Verantwortlicher" oder „Betroffener", wird auf die Definitionen in Art. 4 DSGVO verwiesen.
...
Vertreten durch den Geschäftsführer: Veselin Kolev
...
Wenn Sie als Interessent oder sonstiger Besucher unsere Internetseite aufrufen, erfolgt die Verarbeitung Ihrer personenbezogenen Daten im Rahmen der gesetzlichen Vorschriften bzw. dieser Erklärung. Alle Besucher unserer Internetseite werden unter dem Begriff „Nutzer" zusammengefasst.
...
Weitere Datenkategorien (z. B. Vertragsdaten, Zahlungsdaten, Bestandsdaten im Rahmen einer Registrierung) fallen auf unserer Internetseite nicht an, da kein Vertragsschluss, keine Registrierung und keine Bezahlfunktion über die Seite angeboten wird.

**Zwecke der Verarbeitung:**

- Bereitstellung der Funktionen und Inhalte unseres Onlineangebots
...
Ja, im Rahmen der Nutzung der in Abschnitt VI genannten Dienste werden Daten in die USA übermittelt:
...
Die Server-Logfiles unseres Hosting-Anbieters werden ausschließlich zu den in Abschnitt V genannten Zwecken kurzfristig verarbeitet; die genaue Speicherdauer richtet sich nach den Vorgaben von GitHub als Auftragsverarbeiter.

Daten aus einer E-Mail-Kontaktaufnahme löschen wir, sobald die Bearbeitung Ihrer Anfrage abgeschlossen ist und keine gesetzlichen Aufbewahrungspflichten entgegenstehen. In Deutschland existieren spezielle Aufbewahrungsfristen u. a. gemäß Handelsrecht (§ 257 Abs. 4 HGB) und Steuerrecht (10 Jahre für steuerrechtlich relevante Unterlagen); diese kommen jedoch nur zur Anwendung, soweit aus der Kontaktaufnahme tatsächlich aufbewahrungspflichtige Unterlagen entstehen.
...
- die Löschung Ihrer bei uns gespeicherten personenbezogenen Daten zu verlangen, soweit keine gesetzlichen Aufbewahrungspflichten entgegenstehen (Art. 17 DSGVO);
- die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen (Art. 18 DSGVO);
- Ihre personenbezogenen Daten, die Sie uns bereitgestellt haben, in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten (Art. 20 DSGVO);
...
Sofern Ihre personenbezogenen Daten auf Grundlage berechtigter Interessen gem. Art. 6 Abs. 1 S. 1 lit. f DSGVO verarbeitet werden, haben Sie das Recht, jederzeit aus Gründen, die sich aus Ihrer besonderen Situation ergeben, Widerspruch gegen die Datenverarbeitung einzulegen. Dies hat zur Folge, dass wir die Verarbeitung Ihrer personenbezogenen Daten für die Zukunft nicht mehr fortführen dürfen, es sei denn, wir können zwingende schutzwürdige Gründe für die Verarbeitung nachweisen, die Ihren Interessen, Rechten und Freiheiten überwiegen.

Möchten Sie von Ihrem Widerspruchsrecht Gebrauch machen, genügt eine Nachricht an uns (Kontaktdaten s. o.).

## XI. Bei wem können Sie sich beschweren?

Hinsichtlich der Verarbeitung Ihrer personenbezogenen Daten durch uns haben Sie das Recht, sich bei einer Datenschutz-Aufsichtsbehörde zu beschweren. Zuständig für VAMIT UG (haftungsbeschränkt) ist:
...
## XIII. Findet eine automatisierte Entscheidungsfindung (z. B. Profiling) statt?

Eine automatisierte Entscheidung einschließlich Profiling findet nicht statt.

## XIV. Wie können Sie mit uns Kontakt aufnehmen?

Sie können mit uns per E-Mail Kontakt aufnehmen (s. o.). Sofern Sie uns per E-Mail kontaktieren, speichern wir die von Ihnen freiwillig übermittelten personenbezogenen Daten zu Zwecken der Bearbeitung Ihrer Anfrage. Es erfolgt keine Weitergabe dieser Daten an Dritte.

## XV. Wie sichern wir unsere Internetseite ab?

Unter Berücksichtigung des Stands der Technik, der Implementierungskosten und der Art, des Umfangs, der Umstände und der Zwecke der Verarbeitung treffen wir geeignete technische und organisatorische Maßnahmen, um ein dem Risiko angemessenes Schutzniveau zu gewährleisten (Art. 32 DSGVO).

Unsere Internetseite wird über GitHub Pages ausschließlich verschlüsselt mittels SSL-/TLS-Zertifikat übertragen. Dies erkennen Sie daran, dass in der Adresszeile Ihres Browsers „https" (anstelle von „http") sowie ein Schloss-Symbol erscheint.
...
Nein. Wir betreiben derzeit keine Profile in sozialen Netzwerken, die mit dieser Internetseite verknüpft sind. Sollte sich dies ändern, werden wir diese Datenschutzerklärung entsprechend ergänzen.
